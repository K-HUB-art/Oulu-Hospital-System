...
/*
Oulu Hospital System:-
● Implement the following system for a hospital
● There are 25 different specialization (e.g. Children, Surgery, etc)
● For each specialization, there are only 5 available spots [queue]
● Adding a patient
  -Read the requested specialization [1-25].
...
// Global variables
const int MAX_SPECIALIZATION = 25;
